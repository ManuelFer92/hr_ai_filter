...
/* General text colors - more specific selectors */
...
with tab1:
    ...
    # =========================================================
    # RESULTADOS DETALLADOS - SECCIÓN HORIZONTAL
    # =========================================================
    if final_result:
        ...
        # Intentar obtener datos directamente del JSON parseado primero
        parsed = {
        ...
        # Si no hay datos, intentar parsear del raw_output
        if parsed["resumen"] == "No disponible" and not parsed["fortalezas"] and not parsed["debilidades"]:
            ...
            def parse_llm_text(text):
                ...
                # Primero intentar extraer el JSON del bloque ```json
                ...
                # Si no funciona, intentar con el método anterior (regex)
        ...
        # Crear 3 columnas para los resultados
